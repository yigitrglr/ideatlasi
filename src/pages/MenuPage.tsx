    ...
    >
      <div className="text-center space-y-8 p-4 sm:p-8 animate-smooth-fade-in">
        ...
        <div className="flex flex-col gap-4 max-w-sm mx-auto">
          <Button
            size="lg"
            className="w-full h-14 text-lg transform-gpu hover:scale-105 hover:-translate-y-0.5 hover:shadow-lg active:scale-[0.99] animate-smooth-slide-in"
          ...
          <Button
            variant="outline"
            size="lg"
            className="w-full h-14 text-lg transform-gpu hover:scale-105 hover:-translate-y-0.5 active:scale-[0.99] animate-smooth-slide-in"
            style={{ animationDelay: '0.3s' }}
            onClick={() => navigate('/settings')}
          >
            <Settings className="mr-2 h-5 w-5 transition-transform duration-300 ease-out group-hover:rotate-180" />
            Ayarlar
          </Button>
